...
- **Размер**: 5.0 MB
- **[Скачать APK](https://github.com/oracleh2/ltegate-releases/releases/download/v1.2.6/ltegate-v1.2.6.apk)**

## ✨ Что нового в v1.2.6

### 📊 Расширенная телеметрия устройства
- **Полная информация о сети**: оператор, тип сети, уровень сигнала
- **Мониторинг батареи**: заряд, температура, напряжение
- **Метрики производительности**: CPU, память, хранилище
- **Отслеживание трафика**: отправленные и полученные байты
- **Управление разрешениями**: новый UI для запроса недостающих разрешений
