...
- **Размер**: 5.0 MB
- **[Скачать APK](https://github.com/oracleh2/ltegate-releases/releases/download/v1.2.5/ltegate-v1.2.5.apk)**

## ✨ Что нового в v1.2.5

### 🐛 Критическое исправление управления сервисом
- **Кнопка "Остановить"** теперь корректно изменяется на "Запустить"
- **Состояние сервиса** правильно отображается в интерфейсе
- **Ручная остановка** полностью предотвращает автоперезапуск
- **Синхронизация UI** работает мгновенно без задержек
